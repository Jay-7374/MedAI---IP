...
def get_session(db: Session, session_id: str):
    return (
        ...
        .filter(models.CallSession.id == session_id)
        .first()
    )
...
def get_prompt_template(db: Session, bot_name: str):
    return (
        ...
        .filter(models.PromptTemplate.bot_name == bot_name)
        .first()
    )


def create_or_update_prompt_template(
    db: Session, prompt: schemas.PromptTemplateCreate
):
